...
export const SPECIES: Species[] = [
  ...
  },
  {
    ...
    commonName: "Adelfa",
    family: "Apocynaceae",
    regions: ["andalucia", "murcia", "melilla", "comunidad-valenciana", "castilla-la-mancha"],
  ...
  },
  {
    ...
    commonName: "Boj",
    family: "Buxaceae",
    regions: ["aragon", "cataluna", "navarra", "pais-vasco", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    commonName: "Romero",
    family: "Lamiaceae",
    regions: ["aragon", "andalucia", "murcia", "cataluna", "la-rioja", "comunidad-valenciana", "castilla-la-mancha"],
  ...
  },
  {
    ...
    family: "Ericaceae",
    regions: ["asturias", "cantabria", "galicia", "andalucia", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    regions: ["asturias", "cantabria", "pais-vasco", "castilla-la-mancha"],
  ...
  },
  {
    ...
    commonName: "Tejo",
    family: "Taxaceae",
    regions: ["asturias", "cantabria", "navarra", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    family: "Cupressaceae",
    regions: ["baleares", "murcia", "canarias", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    family: "Rhamnaceae",
    regions: ["baleares", "cataluna", "comunidad-valenciana", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    regions: ["baleares", "murcia", "comunidad-valenciana", "andalucia", "ceuta", "melilla", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    commonName: "Avellano",
    family: "Betulaceae",
    regions: ["cantabria", "asturias", "pais-vasco", "castilla-la-mancha"],
  ...
  },
  {
    ...
    family: "Pinaceae",
    regions: ["castilla-y-leon", "madrid", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    commonName: "Cantueso",
    family: "Lamiaceae",
    regions: ["castilla-y-leon", "andalucia", "murcia", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    family: "Pinaceae",
    regions: ["cataluna", "andalucia", "madrid", "castilla-la-mancha"],
  ...
  },
  {
    ...
    commonName: "Durillo",
    family: "Adoxaceae",
    regions: ["extremadura", "cataluna", "andalucia", "la-rioja", "castilla-la-mancha"],
  ...
  },
  {
    ...
    commonName: "Esparto",
    family: "Poaceae",
    regions: ["murcia", "melilla", "castilla-la-mancha"],
  ...
  // --- La Rioja: Sierra de la Demanda / Sierra Cebollera, valle del Ebro y viñedos ---
  {
    ...
    family: "Fagaceae",
    regions: ["la-rioja", "castilla-y-leon", "madrid", "extremadura", "castilla-la-mancha"],
  ...
  },
  {
    ...
    family: "Anacardiaceae",
    regions: ["la-rioja", "castilla-la-mancha"],
  ...
  // --- Castilla-La Mancha: ampliación de árboles y arbustos (Montes de Toledo, Serranía de ---
  // --- Cuenca, Sierra de Alcaraz), matorral manchego, Lagunas de Ruidera y cultivos icónicos ---
  {
    id: "celtis-australis",
    ...
    family: "Cannabaceae",
    regions: ["castilla-la-mancha"],
    description: "Árbol de gran porte y copa amplia, muy usado tradicionalmente como sombra en plazas de pueblos manchegos; su fruto, la almeza, es un pequeño drupa dulce comestible.",
    rarity: "común",
    properties: ["comestible", "ornamental"],
    uses: "Sus ramas jóvenes, muy flexibles, se han usado tradicionalmente para fabricar mangos de látigo y bastones; su fruto se come al natural.",
    curiosity: "Su madera es tan flexible y resistente que se ha usado tradicionalmente para fabricar horcas de labranza de una sola pieza, curvando la rama del árbol mientras crecía.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Illustration_Celtis_australis1.jpg/330px-Illustration_Celtis_australis1.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "sorbus-aria",
    ...
    family: "Rosaceae",
    regions: ["castilla-la-mancha"],
    description: "Árbol de hoja con el envés blanquecino y afieltrado, muy vistoso al moverse con el viento; sus frutos rojos son comestibles tras sobremadurar.",
    rarity: "poco común",
    properties: ["comestible"],
    uses: "Sus frutos, muy astringentes en fresco, se han consumido tradicionalmente pasados o en mermelada, de forma similar al serbal silvestre.",
    curiosity: "El intenso contraste entre el verde oscuro del haz y el blanco plateado del envés de sus hojas hace que el árbol entero 'brille' al moverse con el viento.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Weilburg_-_Tiergarten_-_Mehlbeere.jpg/330px-Weilburg_-_Tiergarten_-_Mehlbeere.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "acer-opalus",
    scientificName: "Acer opalus",
    commonName: "Arce de Granada",
    family: "Sapindaceae",
    regions: ["castilla-la-mancha"],
    description: "Arce de hoja palmeada que se tiñe de tonos amarillos y anaranjados en otoño, presente de forma dispersa en barrancos húmedos de la Sierra de Alcaraz y la Serranía de Cuenca.",
    rarity: "poco común",
    properties: ["ornamental"],
    uses: "Sin uso tradicional relevante más allá del valor paisajístico de su coloración otoñal.",
    curiosity: "Es uno de los pocos árboles caducifolios que aporta color otoñal intenso en el sur de la Meseta, donde predominan las especies de hoja perenne.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Acer_opalus_leaves_01_by_Line1.JPG/330px-Acer_opalus_leaves_01_by_Line1.JPG?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "prunus-avium",
    ...
    family: "Rosaceae",
    regions: ["castilla-la-mancha"],
    description: "Antepasado silvestre del cerezo cultivado, de floración blanca muy vistosa en primavera y frutos pequeños y ácidos; aparece disperso en umbrías de montaña.",
    rarity: "poco común",
    properties: ["comestible"],
    uses: "Sus frutos, más pequeños y ácidos que los del cerezo cultivado, son comestibles y muy buscados por los pájaros.",
    curiosity: "Todas las variedades de cerezo cultivado del mundo descienden de esta misma especie silvestre europea.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Prunus_avium_range.svg/langes-330px-Prunus_avium_range.svg.png?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "salix-atrocinerea",
    scientificName: "Salix atrocinerea",
    commonName: "Sauce ceniciento",
    family: "Salicaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto o arbolillo de ribera con hojas grisáceas por el envés, forma parte de las saucedas que bordean ríos y arroyos manchegos.",
    rarity: "común",
    properties: [],
    uses: "Sus ramas flexibles se han usado tradicionalmente para tejer cestos rústicos, igual que otras especies de sauce.",
    curiosity: "Sus flores masculinas en amento aparecen antes que las hojas, a finales de invierno, siendo una de las primeras fuentes de polen para las abejas del año.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Salix.jpg/330px-Salix.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "cistus-monspeliensis",
    scientificName: "Cistus monspeliensis",
    commonName: "Jara negra",
    family: "Cistaceae",
    regions: ["castilla-la-mancha"],
    description: "Jara de hojas estrechas y oscuras y flores blancas pequeñas, muy resinosa y aromática, propia de matorrales sobre suelos silíceos degradados.",
    rarity: "común",
    properties: ["aromática"],
    uses: "Como otras jaras, su resina se ha usado tradicionalmente en perfumería como fijador de fragancias.",
    curiosity: "Su color oscuro y aspecto casi quemado incluso en pleno verano le da el nombre popular de 'jara negra', destacando entre las jaras de tonos más claros.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Cistus_May_2014-3.jpg/330px-Cistus_May_2014-3.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "erica-australis",
    scientificName: "Erica australis",
    commonName: "Brezo rubio",
    family: "Ericaceae",
    regions: ["castilla-la-mancha"],
    description: "Brezo de flores rosa-púrpura muy vistosas agrupadas en densos racimos, forma brezales sobre suelos silíceos ácidos de los Montes de Toledo.",
    rarity: "poco común",
    properties: ["melífera"],
    uses: "Como otros brezos, es una planta muy visitada por las abejas para la producción de miel de brezo.",
    curiosity: "Pese a su nombre científico 'australis' (del sur), no tiene relación con Australia: el nombre alude simplemente a su distribución en el suroeste de Europa.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Erica_australis.JPG/330px-Erica_australis.JPG?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "halimium-umbellatum",
    scientificName: "Halimium umbellatum",
    commonName: "Jarilla blanca",
    family: "Cistaceae",
    regions: ["castilla-la-mancha"],
    description: "Pequeño arbusto de flores blancas agrupadas en umbela, emparentado con las jaras, propio de matorrales y pastizales secos silíceos.",
    rarity: "poco común",
    properties: [],
    uses: "Sin uso tradicional relevante documentado.",
    curiosity: "Aunque muy parecida a una jara en flor y hoja, pertenece a un género distinto (Halimium) que se diferencia por detalles del fruto y la semilla.",
  },
  {
    id: "lavandula-pedunculata",
    scientificName: "Lavandula pedunculata",
    commonName: "Cantueso serrano",
    family: "Lamiaceae",
    regions: ["castilla-la-mancha"],
    description: "Lavanda muy similar al cantueso común pero con un pedúnculo floral más largo, propia de matorrales y pastizales sobre suelos ácidos de montaña.",
    rarity: "común",
    properties: ["aromática", "medicinal", "melífera"],
    uses: "Como el resto de lavandas, se usa en infusión relajante y para perfumar armarios y cajones.",
    curiosity: "Durante décadas se consideró una simple variedad del cantueso común, hasta que estudios genéticos confirmaron que merece la categoría de especie propia.",
  },
  {
    id: "genista-cinerea",
    scientificName: "Genista cinerea",
    commonName: "Bolina",
    family: "Fabaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto grisáceo de flores amarillas muy perfumadas, cubre laderas enteras de la Sierra de Alcaraz y el Campo de Montiel en primavera.",
    rarity: "común",
    properties: ["aromática", "melífera"],
    uses: "Sus ramas se han usado tradicionalmente como escobas rústicas y combustible de rápido encendido.",
    curiosity: "En plena floración primaveral puede teñir de amarillo laderas enteras de montaña, siendo uno de los espectáculos florales más vistosos de la Sierra de Alcaraz.",
  },
  {
    id: "adenocarpus-complicatus",
    scientificName: "Adenocarpus complicatus",
    commonName: "Escobón negro",
    family: "Fabaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto de flores amarillas en racimo y vainas cubiertas de glándulas pegajosas, forma parte del matorral de sustitución de robledales y encinares silíceos.",
    rarity: "común",
    properties: [],
    uses: "Sus ramas se han usado tradicionalmente, como otras retamas y escobones, para fabricar escobas rústicas.",
    curiosity: "Sus vainas están cubiertas de pequeñas glándulas pegajosas visibles a simple vista, una característica que ayuda a distinguirlo de otros escobones similares.",
  },
  {
    id: "phillyrea-angustifolia",
    scientificName: "Phillyrea angustifolia",
    commonName: "Labiérnago estrecho",
    family: "Oleaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto de hoja perenne muy estrecha y alargada, emparentado con el olivo, propio del matorral y sotobosque de encinares mediterráneos.",
    rarity: "poco común",
    properties: [],
    uses: "Sin uso tradicional relevante documentado más allá de su valor como refugio para la fauna del matorral.",
    curiosity: "Sus hojas, mucho más estrechas que las de su pariente Phillyrea latifolia, permiten distinguir ambas especies con solo mirar su silueta.",
  },
  {
    id: "daphne-gnidium",
    scientificName: "Daphne gnidium",
    commonName: "Torvisco",
    family: "Thymelaeaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto de hoja perenne estrecha y flores blancas agrupadas, con bayas rojas tóxicas; muy común en el matorral mediterráneo manchego.",
    rarity: "común",
    properties: ["tóxica"],
    uses: "Sin usos seguros para el público general: su corteza y bayas son muy irritantes y tóxicas; tradicionalmente (y de forma peligrosa) se usó como purgante rústico.",
    curiosity: "Su corteza, muy fibrosa y resistente, se usaba antiguamente para fabricar cuerdas rústicas de emergencia en el campo.",
  },
  {
    id: "thymelaea-hirsuta",
    scientificName: "Thymelaea hirsuta",
    commonName: "Bufalaga",
    family: "Thymelaeaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto de aspecto grisáceo y ramas flexibles casi sin hojas visibles, propio de matorrales esteparios y yesosos manchegos.",
    rarity: "poco común",
    properties: ["tóxica"],
    uses: "Sin usos seguros: toda la planta es tóxica; tradicionalmente sus fibras se han usado para cordelería rústica.",
    curiosity: "Sus ramas verdes y flexibles, casi desprovistas de hojas, le permiten reducir al mínimo la pérdida de agua en los ambientes esteparios más secos de La Mancha.",
  },
  {
    id: "helianthemum-apenninum",
    scientificName: "Helianthemum apenninum",
    commonName: "Jara blanca de sierra",
    family: "Cistaceae",
    regions: ["castilla-la-mancha"],
    description: "Pequeño arbusto de flores blancas y hojas estrechas grisáceas, propio de pastizales y matorrales secos de montaña sobre suelo calizo.",
    rarity: "poco común",
    properties: [],
    uses: "Sin uso tradicional relevante documentado.",
    curiosity: "Sus flores, como las de todo el género Helianthemum, solo duran abiertas un día, cerrándose definitivamente al anochecer.",
  },
  {
    id: "fumana-thymifolia",
    scientificName: "Fumana thymifolia",
    commonName: "Fumana",
    family: "Cistaceae",
    regions: ["castilla-la-mancha"],
    description: "Pequeño subarbusto rastrero de flores amarillas diminutas, muy común tapizando pastizales y matorrales secos sobre suelo calizo.",
    rarity: "común",
    properties: [],
    uses: "Sin uso tradicional relevante documentado.",
    curiosity: "Pese a su porte diminuto, pertenece a la misma familia que las grandes jaras del matorral mediterráneo.",
  },
  {
    id: "anthyllis-cytisoides",
    scientificName: "Anthyllis cytisoides",
    commonName: "Albaida",
    family: "Fabaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto grisáceo de flores amarillas muy aromáticas que cubre laderas enteras en el sureste de la provincia de Albacete, dando nombre a los 'albaidares'.",
    rarity: "común",
    properties: ["aromática", "melífera"],
    uses: "Tradicionalmente ramoneada por el ganado como forraje en épocas de escasez; también usada como leña de rápido encendido.",
    curiosity: "En plena floración, sus laderas enteras (los albaidares) desprenden un aroma dulce muy característico que se percibe a distancia en primavera.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Anthyllis_cytisoides_%28flower_spike%29.jpg/330px-Anthyllis_cytisoides_%28flower_spike%29.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    ...
    family: "Fabaceae",
    regions: ["castilla-la-mancha"],
    description: "Pequeño arbusto de flores blancas con la quilla rosada, muy común en matorrales degradados y bordes de camino sobre suelo calizo.",
    rarity: "común",
    properties: ["melífera"],
    uses: "Sin uso tradicional relevante documentado más allá de su valor como planta melífera y forrajera ocasional.",
    curiosity: "Sus flores, blancas con la punta rosada, recuerdan a diminutos guisantes en miniatura agrupados en racimos.",
  },
  {
    id: "viburnum-lantana",
    ...
    family: "Adoxaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto de hoja caduca y flores blancas en corimbo, con frutos que pasan de verde a rojo y finalmente a negro; propio de quejigares y encinares calcáreos de montaña.",
    rarity: "poco común",
    properties: ["ornamental"],
    uses: "Sus ramas jóvenes, muy flexibles, se han usado tradicionalmente para atar fajos y como material de cestería rústica.",
    curiosity: "Sus frutos cambian de color según maduran, por lo que en un mismo racimo pueden verse a la vez frutos verdes, rojos y negros.",
  },
  {
    id: "berberis-hispanica",
    scientificName: "Berberis hispanica",
    commonName: "Agracejo de Sierra de Alcaraz",
    family: "Berberidaceae",
    regions: ["castilla-la-mancha"],
    description: "Arbusto espinoso de flores amarillas y bayas rojas ácidas, endémico del sureste ibérico, presente en roquedos y matorrales de montaña de la Sierra de Alcaraz.",
    rarity: "endémica",
    properties: ["comestible"],
    uses: "Sus bayas ácidas, ricas en vitamina C, se han consumido tradicionalmente frescas o en conserva en algunas zonas rurales.",
    curiosity: "A diferencia del agracejo común del norte peninsular, esta especie está adaptada a la sequía y el calor del sureste ibérico.",
  },
  {
    id: "teucrium-capitatum",
    scientificName: "Teucrium capitatum",
    commonName: "Zamarrilla",
    family: "Lamiaceae",
    regions: ["castilla-la-mancha"],
    description: "Pequeño subarbusto aromático de flores rosa-púrpura agrupadas en densas cabezuelas, muy común en pastizales y matorrales secos calizos.",
    rarity: "común",
    properties: ["aromática", "medicinal"],
    uses: "En infusión se ha usado tradicionalmente como digestivo y para aliviar afecciones respiratorias leves.",
    curiosity: "Forma parte del grupo de plantas conocidas popularmente como 'tomillos' en sentido amplio, aunque pertenece a un género distinto del tomillo verdadero.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Teucrium_capitatum2006.jpg/330px-Teucrium_capitatum2006.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    ...
    family: "Cyperaceae",
    regions: ["castilla-la-mancha"],
    description: "Planta acuática de tallos cilíndricos muy altos sin hojas aparentes, forma densos carrizales en las orillas de las Lagunas de Ruidera y las Tablas de Daimiel.",
    rarity: "poco común",
    properties: [],
    uses: "Sus tallos fibrosos se han usado tradicionalmente para tejer esteras y asientos de sillas en zonas de humedal.",
    curiosity: "Sus tallos, huecos por dentro, pueden superar los dos metros de altura pese a crecer directamente sobre el agua.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Schoenoplectus_lacustris_260605a.jpg/330px-Schoenoplectus_lacustris_260605a.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "myriophyllum-spicatum",
    scientificName: "Myriophyllum spicatum",
    commonName: "Milhojas de agua",
    family: "Haloragaceae",
    regions: ["castilla-la-mancha"],
    description: "Planta acuática sumergida de hojas finamente divididas como plumas, forma praderas bajo el agua en las Lagunas de Ruidera y otras aguas limpias manchegas.",
    rarity: "poco común",
    properties: [],
    uses: "Sin uso tradicional relevante; es un importante refugio y fuente de oxígeno para la fauna acuática.",
    curiosity: "Solo su espiga de flores diminutas asoma por encima del agua; el resto de la planta permanece siempre sumergida.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/MyriophyllumSpicatum.jpg/330px-MyriophyllumSpicatum.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "ranunculus-peltatus",
    scientificName: "Ranunculus peltatus",
    commonName: "Ranúnculo acuático",
    family: "Ranunculaceae",
    regions: ["castilla-la-mancha"],
    description: "Planta acuática de flores blancas flotantes con centro amarillo, característica de las aguas cristalinas de las Lagunas de Ruidera.",
    rarity: "poco común",
    properties: [],
    uses: "Sin uso tradicional relevante documentado.",
    curiosity: "Tiene dos tipos de hojas distintas en la misma planta: unas finamente divididas bajo el agua y otras redondeadas flotando en la superficie.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Ranunculus_peltatus.jpg/330px-Ranunculus_peltatus.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "nymphaea-alba",
    scientificName: "Nymphaea alba",
    commonName: "Nenúfar blanco",
    family: "Nymphaeaceae",
    regions: ["castilla-la-mancha"],
    description: "Planta acuática de grandes flores blancas flotantes y hojas circulares, presente en algunas de las Lagunas de Ruidera de aguas más tranquilas.",
    rarity: "rara",
    properties: ["ornamental"],
    uses: "Sin uso tradicional relevante en la zona; su interés es sobre todo paisajístico y ecológico.",
    curiosity: "Sus flores se abren por la mañana y se cierran al atardecer, repitiendo este ciclo durante varios días antes de hundirse bajo el agua para madurar el fruto.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Nymphaea_alba.jpg/330px-Nymphaea_alba.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "silybum-marianum",
    ...
    family: "Asteraceae",
    regions: ["castilla-la-mancha"],
    description: "Cardo robusto de hojas verde oscuro veteadas de blanco y grandes capítulos morados espinosos, muy común en barbechos y baldíos manchegos.",
    rarity: "común",
    properties: ["medicinal"],
    uses: "Sus semillas son la base de extractos tradicionalmente usados como protectores hepáticos.",
    curiosity: "Según la leyenda cristiana, las vetas blancas de sus hojas serían gotas de leche de la Virgen María caídas sobre la planta, de ahí su nombre.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Illustration_Silybum_marianum0.jpg/330px-Illustration_Silybum_marianum0.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "onopordum-acanthium",
    scientificName: "Onopordum acanthium",
    commonName: "Cardo borriquero",
    family: "Asteraceae",
    regions: ["castilla-la-mancha"],
    description: "Uno de los cardos de mayor porte de la flora ibérica, con tallos alados espinosos y grandes capítulos morados; muy común en baldíos y cunetas manchegas.",
    rarity: "común",
    properties: ["ornamental"],
    uses: "Sin uso tradicional relevante en alimentación; su gran porte seco se usa ocasionalmente en composiciones florales decorativas.",
    curiosity: "Puede superar los dos metros de altura, y toda la planta (tallos, hojas y brácteas) está cubierta de espinas afiladas como defensa frente a los herbívoros.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Oset_-_Rewa_-_zoom.jpeg/330px-Oset_-_Rewa_-_zoom.jpeg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "thapsia-villosa",
    scientificName: "Thapsia villosa",
    commonName: "Cañaheja",
    family: "Apiaceae",
    regions: ["castilla-la-mancha"],
    description: "Planta de gran porte con umbelas amarillas y hojas muy divididas, típica de baldíos y bordes de camino manchegos, muy visible en los paisajes de La Mancha en verano.",
    rarity: "común",
    properties: ["tóxica"],
    uses: "Sin usos seguros para el público general: su savia es tóxica e irritante para la piel; tradicionalmente sus tallos secos se usaron como yesca para encender fuego.",
    curiosity: "Sus tallos secos y huecos, muy resistentes, se usaban tradicionalmente en algunas zonas para transportar brasas de un lugar a otro.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Thapsia_villosa_Puertollano.jpg/330px-Thapsia_villosa_Puertollano.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "allium-sativum",
    ...
    family: "Amaryllidaceae",
    regions: ["castilla-la-mancha"],
    description: "Planta bulbosa cultivada desde la Antigüedad como condimento; Las Pedroñeras (Cuenca) es la mayor zona productora y exportadora de ajo de Europa.",
    rarity: "común",
    properties: ["comestible", "medicinal", "aromática"],
    uses: "Condimento fundamental de la cocina manchega; tradicionalmente también se ha usado como remedio popular por sus propiedades antisépticas.",
    curiosity: "Las Pedroñeras produce y comercializa una parte muy significativa de todo el ajo que se consume en Europa, con Denominación de Origen Protegida propia.",
  ...
  },
  {
    ...
    commonName: "Pistachero",
    family: "Anacardiaceae",
    regions: ["castilla-la-mancha"],
    description: "Árbol cultivado por su fruto seco, el pistacho; su cultivo se ha extendido enormemente por La Mancha en las últimas dos décadas, adaptándose muy bien al clima seco de la región.",
    rarity: "común",
    properties: ["comestible", "antioxidante"],
    uses: "Su fruto, el pistacho, se consume tostado como fruto seco y es rico en grasas saludables y antioxidantes.",
    curiosity: "Castilla-La Mancha se ha convertido en dos décadas en una de las principales regiones productoras de pistacho de Europa, superando ya a países mediterráneos con tradición mucho más antigua en este cultivo.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Pistachio_vera.jpg/330px-Pistachio_vera.jpg?utm_source=es.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
  {
    id: "cucumis-melo",
    ...
    family: "Cucurbitaceae",
    regions: ["castilla-la-mancha"],
    description: "Planta trepadora o rastrera cultivada por su fruto dulce, el melón; La Mancha es una de las principales zonas productoras de melón de España.",
    rarity: "común",
    properties: ["comestible", "antioxidante"],
    uses: "Su fruto se consume fresco como postre de verano; es muy rico en agua y antioxidantes como el betacaroteno.",
    curiosity: "El calor seco y los suelos de La Mancha son especialmente favorables para concentrar los azúcares del melón, dándole su característico sabor dulce.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Muskmelon.jpg/330px-Muskmelon.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail",
  },
];
