...
(function () {
  ...
  function openSpeciesSheet(spId) {
    ...
    $('#speciesSheetContent').innerHTML = `
      ...
      ${sp.foto ? `<div class="species-photo"><img src="${sp.foto}" alt="${nombre} (${sp.cientifico})" loading="lazy" />${sp.fotoCredito ? `<span class="species-photo-credit">Foto: ${sp.fotoCredito}</span>` : ''}</div>` : ''}
      <div class="sheet-header">
